...
/**
  ...
  */
object MinHashforJaccardDistanceDemo extends App with BasicClass{
  ...
  //val key = Vectors.sparse(6, Seq((2, 1.0), (1, 1.0)))
  val key = Vectors.sparse(6, Seq((3, 1.0), (1, 1.0),(4,1.0)))
